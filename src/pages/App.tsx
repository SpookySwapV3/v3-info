...
import { SUPPORTED_NETWORK_VERSIONS, FantomNetworkInfo, GoatTestnetNetworkInfo } from 'constants/networks'
...
export default function App() {
  ...
  useEffect(() => {
    if (location.pathname === '/') {
      setActiveNetwork(GoatTestnetNetworkInfo)
    } else {
              ...
              <BodyWrapper>
                <DarkGreyCard style={{ maxWidth: '340px' }}>
                  <TYPE.label>
                    ...
                    current status{' '}
                    <ExternalLink href="https://api.thegraph.com/subgraphs/name/0xalucard/ftm-spooky-v3">
                      here.
                    </ExternalLink>
                  </TYPE.label>
                </DarkGreyCard>
