...
import { FantomNetworkInfo, EonNetworkInfo, SUPPORTED_NETWORK_VERSIONS } from 'constants/networks'
    ...
    <Container ref={node}>
      <Wrapper onClick={() => setShowMenu(!showMenu)}>
        <RowFixed>
          ...
          {[FantomNetworkInfo, EonNetworkInfo].includes(activeNetwork) ? null : (
