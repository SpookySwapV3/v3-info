...
import { FantomNetworkInfo, EonNetworkInfo, BttcNetworkInfo, SUPPORTED_NETWORK_VERSIONS } from 'constants/networks'
    ...
    <Container ref={node}>
      <Wrapper onClick={() => setShowMenu(!showMenu)}>
        <RowFixed>
          ...
          {[FantomNetworkInfo, EonNetworkInfo, BttcNetworkInfo].includes(activeNetwork) ? null : (
