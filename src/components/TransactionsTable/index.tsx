...
const DataRow = ({ transaction, color }: { transaction: Transaction; color?: string }) => {
  ...
  return (
    <ResponsiveGrid>
      <ExternalLink href={getExplorerLink(chainId, transaction.hash, ExplorerDataType.TRANSACTION)}>
      ...
      <Label end={1} fontWeight={400}>
        <ExternalLink
          href={getExplorerLink(chainId, transaction.sender, ExplorerDataType.ADDRESS)}
